...
const FORMSPREE_URL = 'https://formspree.io/f/xlgyolwd';
      ...
      <div className="contact__wrapper">
        <div className="reveal-left">
          ...
          {[
            ...
            <div className="contact__item" key={item.label}>
              <div className="contact__icon-box" aria-hidden="true">{item.icon}</div>
              <div>
        ...
        <form className="contact__form reveal-right" onSubmit={handleSubmit}>
          ...
          <div className="form-group">
            ...
            <textarea id="message" name="message" placeholder="Tell us about your requirement, quantity, and project details…"/>
          </div>
          <button
            type="submit"
            className={`contact__submit ${status === 'success' ? 'sent' : ''}`}
