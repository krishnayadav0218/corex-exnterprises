...
export default function Contact() {
  ...
  const handleSubmit = async (e) => {
    ...
    formData.append('subject', 'New Enquiry from CoreX Enterprises Website');
    formData.append('from_name', 'CoreX Enterprises Website');
    try {
    ...
    <section className="contact sec-styled" id="contact" style={sectionStyle}>
      ...
      <div className="contact__wrapper">
        ...
        <form className="contact__form reveal-right" onSubmit={handleSubmit}>
          ...
          <input type="hidden" name="subject" value="New Enquiry — CoreX Enterprises" />
